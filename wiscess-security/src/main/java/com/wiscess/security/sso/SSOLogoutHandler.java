...
public class SSOLogoutHandler implements LogoutHandler {
	...
	public SSOLogoutHandler(String logoutUrl,EncryptHandler encryptHandler) {
		this(logoutUrl,encryptHandler,true);
	}
	public SSOLogoutHandler(String logoutUrl,EncryptHandler encryptHandler,boolean invalidateHttpSession) {
