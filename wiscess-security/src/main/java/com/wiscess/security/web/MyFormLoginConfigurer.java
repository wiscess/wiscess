...
public final class MyFormLoginConfigurer<H extends HttpSecurityBuilder<H>>
	extends AbstractAuthenticationFilterConfigurer<H, MyFormLoginConfigurer<H>, MyUsernamePasswordAuthenticationFilter> {
	...
	public MyFormLoginConfigurer() {
		super(new MyUsernamePasswordAuthenticationFilter(), null);
	...
	public MyFormLoginConfigurer<H> codeParameter(String codeParameter) {
